...
export const metadata: Metadata = {
  ...
  description: 'The whole month at a glance — scheduled tasks, routines, and deadlines, with a tap to plan any day.',
}
    ...
    <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <header className="sticky top-0 z-10 bg-zinc-50/90 dark:bg-zinc-950/90 backdrop-blur-sm border-b border-zinc-200 dark:border-zinc-800">
        <div className="max-w-xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-lg font-semibold text-zinc-900 dark:text-white tracking-tight">The month ahead</h1>
            <p className="text-xs text-zinc-400">See what’s scheduled across the month</p>
          </div>
